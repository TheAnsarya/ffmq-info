...
def generate_enemy_stats_asm(enemies: List[Dict]) -> str:
    ...
    asm_lines.append(";==============================================================================")
    asm_lines.append("")
    asm_lines.append(f"org ${ENEMY_STATS_ROM_ADDR:04X}")
    asm_lines.append("")
...
def generate_enemy_level_asm(enemies: List[Dict]) -> str:
    ...
    asm_lines.append(";==============================================================================")
    asm_lines.append("")
    asm_lines.append(f"org ${ENEMY_LEVEL_ROM_ADDR:04X}")
    asm_lines.append("")
...
def main():
    ...
    # Generate stats ASM
    print("🔨 Generating enemy stats assembly...")
    ...
    # Generate level ASM
    print("🔨 Generating enemy level assembly...")
