...
class GraphicsASMGenerator:
	...
	def generate_category_asm(self, category: str) -> Optional[Path]:
		...
		"""
		print(f"  📝 Generating ASM for {category}...")
	...
	def generate_all(self) -> bool:
		...
		Returns:
			True if successful
		"""
		print("\n🔨 Generating graphics ASM includes...")
		...
		if not categories:
			print("  ⚠️  No rebuilt graphics found")
			return False
